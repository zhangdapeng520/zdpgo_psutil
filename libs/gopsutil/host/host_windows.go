...
import (
	...
	"github.com/zhangdapeng520/zdpgo_psutil/libs/wmi"
	"golang.org/x/sys/windows"
)

var (
	procGetSystemTimeAsFileTime = common2.Modkernel32.NewProc("GetSystemTimeAsFileTime")
	procGetTickCount32          = common2.Modkernel32.NewProc("GetTickCount")
	procGetTickCount64          = common2.Modkernel32.NewProc("GetTickCount64")
	procGetNativeSystemInfo     = common2.Modkernel32.NewProc("GetNativeSystemInfo")
	procRtlGetVersion           = common2.ModNt.NewProc("RtlGetVersion")
)
...
func SensorsTemperaturesWithContext(ctx context.Context) ([]TemperatureStat, error) {
	...
	if err := common2.WMIQueryWithContext(ctx, q, &dst, nil, "root/wmi"); err != nil {
		return ret, err
	}
