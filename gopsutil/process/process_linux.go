...
import (
	...
	"github.com/zhangdapeng520/zdpgo_psutil/sysconf"
...
func (p *Process) ForegroundWithContext(ctx context.Context) (bool, error) {
	...
	pid := p.Pid
	statPath := common2.HostProc(strconv.Itoa(int(pid)), "stat")
...
func (p *Process) ThreadsWithContext(ctx context.Context) (map[int32]*cpu.TimesStat, error) {
	...
	taskPath := common2.HostProc(strconv.Itoa(int(p.Pid)), "task")
...
func (p *Process) MemoryMapsWithContext(ctx context.Context, grouped bool) (*[]MemoryMapsStat, error) {
	...
	smapsPath := common2.HostProc(strconv.Itoa(int(pid)), "smaps")
	if grouped {
		...
		smapsRollupPath := common2.HostProc(strconv.Itoa(int(pid)), "smaps_rollup")
...
func (p *Process) EnvironWithContext(ctx context.Context) ([]string, error) {
	environPath := common2.HostProc(strconv.Itoa(int(p.Pid)), "environ")
...
func (p *Process) fillFromLimitsWithContext() ([]RlimitStat, error) {
	pid := p.Pid
	limitsFile := common2.HostProc(strconv.Itoa(int(pid)), "limits")
...
func (p *Process) fillFromfdListWithContext(ctx context.Context) (string, []string, error) {
	pid := p.Pid
	statPath := common2.HostProc(strconv.Itoa(int(pid)), "fd")
...
func (p *Process) fillFromCwdWithContext() (string, error) {
	pid := p.Pid
	cwdPath := common2.HostProc(strconv.Itoa(int(pid)), "cwd")
...
func (p *Process) fillFromExeWithContext() (string, error) {
	pid := p.Pid
	exePath := common2.HostProc(strconv.Itoa(int(pid)), "exe")
...
func (p *Process) fillFromCmdlineWithContext(ctx context.Context) (string, error) {
	pid := p.Pid
	cmdPath := common2.HostProc(strconv.Itoa(int(pid)), "cmdline")
...
func (p *Process) fillFromIOWithContext() (*IOCountersStat, error) {
	pid := p.Pid
	ioPath := common2.HostProc(strconv.Itoa(int(pid)), "io")
...
func (p *Process) fillFromStatmWithContext() (*MemoryInfoStat, *MemoryInfoExStat, error) {
	pid := p.Pid
	memPath := common2.HostProc(strconv.Itoa(int(pid)), "statm")
...
func (p *Process) fillFromCommWithContext() error {
	pid := p.Pid
	statPath := common2.HostProc(strconv.Itoa(int(pid)), "comm")
	contents, err := ioutil.ReadFile(statPath)
	if err != nil {
		return err
	}
...
func (p *Process) fillFromStatusWithContext(ctx context.Context) error {
	pid := p.Pid
	statPath := common2.HostProc(strconv.Itoa(int(pid)), "status")
	contents, err := ioutil.ReadFile(statPath)
	if err != nil {
		return err
	}
...
func (p *Process) fillFromTIDStatWithContext(ctx context.Context, tid int32) (uint64, int32, *cpu.TimesStat, int64, uint32, int32, *PageFaultsStat, error) {
	...
	if tid == -1 {
		...
		statPath = common2.HostProc(strconv.Itoa(int(pid)), "task", strconv.Itoa(int(tid)), "stat")
	}
...
func pidsWithContext(ctx context.Context) ([]int32, error) {
	return readPidsFromDir(common2.HostProc())
}
