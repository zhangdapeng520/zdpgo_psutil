...
var (
	procGetDiskFreeSpaceExW     = common2.Modkernel32.NewProc("GetDiskFreeSpaceExW")
	procGetLogicalDriveStringsW = common2.Modkernel32.NewProc("GetLogicalDriveStringsW")
	procGetDriveType            = common2.Modkernel32.NewProc("GetDriveTypeW")
	procGetVolumeInformation    = common2.Modkernel32.NewProc("GetVolumeInformationW")
)
